<template>
  <div class="space-y-10">
    <section class="mx-auto w-full space-y-8 font-sans">
      ...
      <div class="space-y-4">
        ...
        <p class="text-base leading-relaxed text-gray-700">
          The initiative was originally started by Miguel Montalvo, a PhD student in Astrophysical Sciences at Princeton University, Fernanda Sulantay, a PhD student in Chemical Engineering at Yale University and Erick Urquilla, a PhD student in Physics at the University of Tennessee. Soon after, more Salvadoran students and researchers joined the effort, including undergraduate students, PhD candidates, and postdoctoral researchers across multiple scientific disciplines.
        </p>
        <p class="text-base leading-relaxed text-gray-700">
          Today, the community continues to grow and includes Salvadoran scientists working in physics, astronomy, chemistry, engineering, and related fields at institutions around the world. Our goal is to create a space where Salvadoran scientists can connect, share opportunities, exchange experiences, collaborate academically, and inspire future generations of students from El Salvador.
        </p>
        <p class="text-base leading-relaxed text-gray-700">
          Beyond research, we believe that building a scientific community is also about belonging. By strengthening connections among Salvadoran scientists internationally, we hope to contribute not only to each other’s professional growth, but also to the long-term development of science, education, and scientific culture in El Salvador.
        </p>
      </div>
      ...
      <div class="space-y-4">
        ...
        <p class="text-base leading-relaxed text-gray-700">
          El Salvador has produced researchers contributing to some of the most exciting frontiers of modern science — from astrophysics and computational physics to biology, engineering, and beyond. Yet too often, that work remains invisible to the next generation of students and scientists in the country. This repository exists to change that.
        </p>
        <p class="text-base leading-relaxed text-gray-700">
          By creating a living, open record of Salvadoran scientific output and the people behind it, we aim to strengthen collaboration between international researchers and local universities, foster new partnerships, and accelerate the internationalization of Salvadoran science.
        </p>
        <p class="text-base leading-relaxed text-gray-700">
